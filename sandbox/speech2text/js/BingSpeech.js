...
(function (BingSpeech) {
        ...
        checkAuthToken() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this.authToken === "" || timeElapsed > 500) {
                    ...
                    try {
                        var resultsText = yield this.makeHttpRequest("POST", "https://"+ this.zone +".api.cognitive.microsoft.com/sts/v1.0/issuetoken", false, optionalHeaders);
    ...
    class RecognitionClient {
        ...
        * Paid: https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/Bing.Speech/pricingtier/S0
        */
        constructor(apiKey, locale = "en-us", zone) {
            ...
            this._tools = new Tools(apiKey,zone);
        ...
        recognizeAudio(audio, locale) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    response = yield this._tools.makeHttpRequest("POST", "https://" + this._tools.zone + ".stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1" + requestParameters, false, optionalHeaders, blob);
    ...
    class TTSClient {
        ...
        * Paid: https://portal.azure.com/#create/Microsoft.CognitiveServices/apitype/Bing.Speech/pricingtier/S0
        */
        constructor(apiKey, locale = SupportedLocales.enUS_Male, zone) {
